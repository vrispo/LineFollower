...
@REM   i.e.   ${workspace_loc:LineFollower}/make_launcher.bat
...
@set ERIKA_FILES=C:\Users\4R35\Desktop\eclipse\plugins\com.eu.evidence.ee_2.8.0.20171025_0922\ee_files
